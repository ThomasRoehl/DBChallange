...
public class CalendarAdapter extends BaseAdapter {
    ...
    public CalendarAdapter(Context context, GregorianCalendar monthCalendar,ArrayList<CalendarCollection> date_collection_arr) {
        ...
        monthCalendar.setFirstDayOfWeek(GregorianCalendar.MONDAY);
        month = monthCalendar;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (day_string.get(position).equals(curentDateString)) {
            //v.setBackgroundColor(Color.parseColor("#d7d5d5"));
            v.setBackgroundColor(Color.WHITE);
            //v.setBackgroundColor(Color.YELLOW); //background of current day

        } else {
            //v.setBackgroundColor(Color.parseColor("#d7d5d5"));
            v.setBackgroundColor(Color.WHITE);  //background of calender
...
//        }
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (len1>pos) {
                ...
                if (day_string.get(pos).equals(date)) {
                    ...
                    v.setBackgroundResource(R.drawable.dblogo1);
    ...
    public void getPositionList(String date){
        ...
        for (int i = 0; i < len; i++) {
            ...
            String event_message=cal_collection.connections_info;
